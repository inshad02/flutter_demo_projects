...
class Medicalscreenrecord extends StatefulWidget {
  const Medicalscreenrecord({super.key});

  @override
  State<Medicalscreenrecord> createState() => _MedicalscreenrecordState();
}

class _MedicalscreenrecordState extends State<Medicalscreenrecord> {
  @override
